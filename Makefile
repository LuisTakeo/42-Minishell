...
SRC_EXPANSOR := $(addprefix $(SRC_EXPANSOR_FOLDER), $(addsuffix .c, expand_env expand_quotes expand_word expand_vars_quotes))
...
SRC_EXEC := $(addprefix $(SRC_EXEC_FOLDER), $(addsuffix .c, verify_path generate_redirs setup_redirs heredoc exec_command exec_tree_commands status))
